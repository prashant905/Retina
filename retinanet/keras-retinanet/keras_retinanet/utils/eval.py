...
from .visualization import draw_detections, draw_annotations,draw_iou
...
def _compute_ap(recall, precision):
    ...
    print ("mrec:",mrec)
    print ("mrecshape",mrec.shape)
    mpre = np.concatenate(([0.], precision, [0.]))
    print ("mpre:",mpre)
    print("mpre:",mpre.shape)
...
def _get_detections(generator, model, score_threshold=0.05, max_detections=100, save_path=None):
    ...
    for i in range(generator.size()):
        ...
        if save_path is not None:
            ...
            draw_iou(raw_image,generator.load_annotations(i),detections[0, indices[0][scores_sort], :],generator=generator)
